...
function M.config()
  ...
  if vim.fn.has "mac" == 1 then
    rvim.keys.normal_mode["<A-Up>"] = rvim.keys.normal_mode["<C-Up>"]
    rvim.keys.normal_mode["<A-Down>"] = rvim.keys.normal_mode["<C-Down>"]
    rvim.keys.normal_mode["<A-Left>"] = rvim.keys.normal_mode["<C-Left>"]
    rvim.keys.normal_mode["<A-Right>"] = rvim.keys.normal_mode["<C-Right>"]
...
function M.print(mode)
  ...
  if mode then
    print(vim.inspect(rvim.keys[mode]))
  else
    print(vim.inspect(rvim.keys))
  end
end
