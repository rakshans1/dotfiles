...
M.setup = function()
  ...
  if package.loaded["cmp"] then
    require("nvim-autopairs.completion.cmp").setup {
      map_cr = rvim.builtin.autopairs.map_cr,
      map_complete = rvim.builtin.autopairs.map_complete,
      auto_select = rvim.builtin.autopairs.auto_select,
      insert = rvim.builtin.autopairs.insert,
      map_char = rvim.builtin.autopairs.map_char,
    }
  end
